...
public class ScoresDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        final String CreateScoresTable = "CREATE TABLE " + DatabaseContract.SCORES_TABLE + " ("
                ...
                + DatabaseContract.scores_table.MATCH_TIME_COL + " INTEGER NOT NULL,"
                ...
                + DatabaseContract.scores_table.MATCH_ID_COL + " INTEGER NOT NULL,"
                + DatabaseContract.scores_table.MATCH_DAY_COL + " INTEGER NOT NULL,"
                + " UNIQUE (" + DatabaseContract.scores_table.MATCH_ID_COL + ") ON CONFLICT REPLACE"
                + " );";
